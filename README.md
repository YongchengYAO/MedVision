<div align="center">
  ...
  💿 v1.4.0 | 33.2K 3D images | 12.0M 2D slices | 25.7M single-instance / 50.5M multi-instance annotations | multi-modality | multi-anatomy 💿
...
> [!IMPORTANT]
> **Leaderboard results use annotation v1.0.0.** All leaderboard numbers are computed on the **v1.0.0** annotations. We removed ambiguous cases (multi-instance targets) in metric calculation as a workaround. For new studies we recommend the **latest** annotation version (currently **v1.4.0**).

💫 Quick start: use [MedVision Data Explorer](https://medvision-vlm.github.io/explorer.html)
...
- **Benchmark subtasks ↔ dataset subsets.** Each subtask in this benchmark links to a subset of the MedVision dataset. The per-subtask sample sizes are listed for every dataset version `1.0.0`–`1.4.0`:
  - [`all_tasks__ds_v1.1.1`](https://github.com/YongchengYAO/MedVision/tree/master/dataset-info/all_tasks__ds_v1.1.1): we use this for OOD ablation since we fixed the annotation error for sagittal and coronal slices from `v1.1.1`
  - [`all_tasks__ds_v1.0.0`](https://github.com/YongchengYAO/MedVision/tree/master/dataset-info/all_tasks__ds_v1.0.0): we use single instance annotations from `v1.0.0` in all benchmarking tasks

  These lists are generated by streaming each config, so a subtask appears only if that pin can actually load it — which makes them narrower than the annotation totals further down: MAMA-MIA and PI-CAI cannot be loaded at a `1.2.0` pin (withdrawn, republished as `1.2.1`), and the AFIDs / PDDCA / VerSe biometry plans are paused at every pin, leaving A/D with only Ceph-Biometrics-400 and FeTA24.
...
<table>
  ...
  <tr>
    <td align="center"><picture><source media="(prefers-color-scheme: dark)" srcset="dataset-info/datasets_summary_v1.4.0/dataset_summary_rings_filtered_2x1_whitebg.svg"><img src="dataset-info/datasets_summary_v1.4.0/dataset_summary_rings_filtered_2x1.svg" width="100%" alt="v1.4.0 single-instance donut"></picture></td>
    <td align="center"><picture><source media="(prefers-color-scheme: dark)" srcset="dataset-info/datasets_summary_v1.4.0/dataset_summary_rings_raw_2x1_whitebg.svg"><img src="dataset-info/datasets_summary_v1.4.0/dataset_summary_rings_raw_2x1.svg" width="100%" alt="v1.4.0 multi-instance donut"></picture></td>
  </tr>
</table>
...
<details>
<summary> MedVision v1.3.0 </summary>

<br/>

**Adds MSWAL** (CT, 484 volumes). No annotation logic changed — every v1.2.0 count is carried over unmodified.
...
<table>
  ...
  <tr>
    <td align="center"><picture><source media="(prefers-color-scheme: dark)" srcset="dataset-info/datasets_summary_v1.3.0/dataset_summary_rings_filtered_2x1_whitebg.svg"><img src="dataset-info/datasets_summary_v1.3.0/dataset_summary_rings_filtered_2x1.svg" width="100%" alt="v1.3.0 single-instance donut"></picture></td>
    <td align="center"><picture><source media="(prefers-color-scheme: dark)" srcset="dataset-info/datasets_summary_v1.3.0/dataset_summary_rings_raw_2x1_whitebg.svg"><img src="dataset-info/datasets_summary_v1.3.0/dataset_summary_rings_raw_2x1.svg" width="100%" alt="v1.3.0 multi-instance donut"></picture></td>
  </tr>
</table>
...
<details>
<summary> MedVision v1.2.0 </summary>
...
> [!NOTE]
> **Per-slice QC figures are opt-in** (`MedVision_DOWNLOAD_QC_FIGURES`, default `False`).
>
> ```bash

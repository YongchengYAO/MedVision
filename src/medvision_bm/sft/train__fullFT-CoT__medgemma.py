"""
Full finetuning (no LoRA) variant for MedGemma, CoT multi-task SFT.
...
NOTE: the existing dev/train__SFT__medgemma.py is the LoRA variant; this is the
full-FT CoT counterpart, parallel to train__fullFT-CoT__qwen2_5_vl.py.
...
Multi-GPU usage:
  > accelerate launch -m medvision_bm.sft.train__fullFT-CoT__medgemma [args]
"""

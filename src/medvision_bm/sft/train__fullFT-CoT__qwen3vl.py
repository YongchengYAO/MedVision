"""
Full finetuning (no LoRA) variant for Qwen3-VL, CoT multi-task SFT.

Mirrors train__fullFT-CoT__qwen2_5_vl.py; the only model-specific piece is the
collate function. Qwen3-VL shares the Qwen ChatML chat format
...
Multi-GPU usage:
  > accelerate launch -m medvision_bm.sft.train__fullFT-CoT__qwen3vl [args]
"""

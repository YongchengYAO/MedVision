...
"""
# FIXME: This file is currently undergoing debugging: nan loss and grad_norm issues.
    ...
    **kwargs,
    ...
    if not kwargs.get("merge_only"):
        ...
        dataset = prepare_dataset_TumorLesionTask(
            ...
            tag_ds="TumorLesionSize", # MedVision dataset specific, used to extract dataset name from TL task configs

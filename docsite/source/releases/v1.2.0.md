...
Release notes for the `medvision_bm` codebase, **v1.2.0**. Use the version switcher
(bottom-right on Read the Docs) to read the docs for a different release.
...
- Every launch script now states its output length instead of relying on a default: 4096 for 46 of the 57 open-weight scripts, raised to 16000 for GLM-4.6V, GLM-4.6V-Flash, MedGemma-27B and Llama-3.2-Vision, and 16384 for MiniMax-M3 — all of which were running out of room (83e3187)

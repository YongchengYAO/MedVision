...
see. It ships a large annotated dataset (22 source datasets across CT, MRI, PET,
ultrasound and X-ray — 29K 3D images, 11.2M annotated 2D slices, and 24.3M
single-instance / 45.3M multi-instance annotations), a reproducible benchmark

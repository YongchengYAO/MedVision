...
- **Benchmarking** — the three-step `eval → parse → summarize` pipeline and the metrics, plus two follow-on analyses: LLM-judge re-parsing and clinical decision agreement.
...
benchmarking/llm-judge-parsing
benchmarking/clinical-decision-agreement
```

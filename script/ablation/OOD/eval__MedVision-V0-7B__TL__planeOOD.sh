...
task_tag="MedVision-TL-CoT-planeOOD"
result_dir="${benchmark_dir}/Results/${task_tag}"
tasks_list_json_path="${benchmark_dir}/tasks_list/OOD/tasks_MedVision-TL-CoT-planeOOD.json"
...
# Use MedVision dataset v1.1.1
# NOTE: Must use v1.1.1 for sagittal and coronal slices in T/L task 
# Release note: https://github.com/YongchengYAO/MedVision/blob/master/docs/dataset-release/release-v1.1.1.md

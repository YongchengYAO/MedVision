...
# Data configs
# NOTE: We are using a debug tasks list here for quick testing.
tasks_list_json_path="${benchmark_dir}/tasks_list/tasks_MedVision-AD__debug.json"

# Model configs
base_model_hf="Qwen/Qwen2.5-VL-7B-Instruct"
run_name="MedVision__SFT__qwen25vl-7b__AD"
...
merged_model_hf="MedVision__SFT-m__qwen25vl-7b__AD"
...
val_sample_limit=10 # NOTE: debugging

...
run_name="MedVision__SFT__medgemma-27b-it__AD"
...
merged_model_hf="MedVision__SFT-m__medgemma-27b-it__AD"
...
-m  medvision_bm.sft.train__SFT__medgemma__AD \
--run_name ${run_name} \
...
2>&1 | tee train__SFT__medgemma-27b-it__AD.log

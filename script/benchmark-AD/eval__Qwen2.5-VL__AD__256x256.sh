...
# NOTE: 
# ---
# Use '--reshape_image_hw <reshape image size>' to reshape images to a specific size (e.g., 256x256) during evaluation.
# For measurement tasks like A/D and T/L tasks, we ensure that the pixel size in the prompt is consistent with the pixel size of the reshaped input image. 
# That is, if the input image is resized, we will also adjust the pixel size in the prompt accordingly to maintain consistency.  
# 
# Accept formats like:
#     # - a Python list/tuple string: "[896,896]" or "(896,896)"
#     # - comma/space separated: "896,896" or "896 896"
#     # - single integer: "896" -> interpreted as [896,896]
# ---
reshape_image_hw="256,256"
# ---

...
# script/benchmark-TL/eval__MedVision-V0-7B__TL.sh.
#
# Identical to the regular TL eval except it targets the scaledPS task list and
...
task_tag="MedVision-TL-CoT-scaledPS"
result_dir="${benchmark_dir}/Results/${task_tag}"
tasks_list_json_path="${benchmark_dir}/tasks_list/tasks_MedVision-TL-CoT-scaledPS.json"

...
# Data configs
tasks_list_json_path="${benchmark_dir}/tasks_list/tasks_MedVision-detect__train_SFT.json"

# Model configs
base_model_hf="google/medgemma-27b-it"
run_name="MedVision__SFT__medgemma-27b-it__detect"
...
merged_model_hf="MedVision__SFT-m__medgemma-27b-it__detect"
...
-m  medvision_bm.sft.train__SFT__medgemma__detect \
--run_name ${run_name} \
...
2>&1 | tee train__SFT__medgemma-27b-it__detect.log

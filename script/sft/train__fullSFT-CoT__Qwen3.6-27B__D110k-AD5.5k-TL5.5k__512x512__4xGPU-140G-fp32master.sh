...
run_name="MedVision__fullSFT__Qwen3.6-27B__D110k-AD5k-TL5k__CoT__512x512__4xGPU-140G-fp32master"
...
wandb_run_id="Qwen3.6-27B-fullSFT-D110k-AD5k-TL5k-512x512-4xGPU-140G-fp32master" # run ID must be unique in the wandb_project
...
#   4x 140GB GPUs (this model, 2026-07-09: post-wrap allocated 38.2GiB/rank, trains
#   within 139.8GiB). Verify with MEMPROBE: post-wrap allocated ~38GB (a full-model
#   figure means sharding didn't engage).

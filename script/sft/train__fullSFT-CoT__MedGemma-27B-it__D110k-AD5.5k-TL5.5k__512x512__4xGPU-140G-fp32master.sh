...
run_name="MedVision__fullSFT__MedGemma-27B-it__D110k-AD5k-TL5k__CoT__512x512__4xGPU-140G-fp32master"
...
wandb_run_id="MedGemma-27B-fullSFT-D110k-AD5k-TL5k-512x512-4xGPU-140G-fp32master" # run ID must be unique in the wandb_project

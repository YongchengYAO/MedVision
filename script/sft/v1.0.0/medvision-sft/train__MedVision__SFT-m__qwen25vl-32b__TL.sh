...
run_name="MedVision__SFT__qwen25vl-32b__TL"
...
merged_model_hf="MedVision__SFT-m__qwen25vl-32b__TL"
...
wandb_run_id="Qwen25VL32B-TL5k" # run ID must be unique in the wandb_project

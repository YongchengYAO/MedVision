...
run_name="MedVision__SFT__qwen25vl-7b__CoT-AD"
...
merged_model_hf="MedVision__SFT-m__qwen25vl-7b__CoT-AD"
...
wandb_run_id="Qwen25VL7B-CoT-AD5k" # run ID must be unique in the wandb_project

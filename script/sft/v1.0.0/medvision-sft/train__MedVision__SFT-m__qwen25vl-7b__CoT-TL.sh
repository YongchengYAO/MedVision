...
run_name="MedVision__SFT__qwen25vl-7b__CoT-TL"
...
merged_model_hf="MedVision__SFT-m__qwen25vl-7b__CoT-TL"
...
gradient_accumulation_steps=2 # Control effective batch size: effective_batch_size = per_device_train_batch_size * gradient_accumulation_steps * num_gpus
...
wandb_run_id="Qwen25VL7B-CoT-TL5k" # run ID must be unique in the wandb_project

...
run_name="MedVision__SFT__qwen25vl-7b__detect"
...
merged_model_hf="MedVision__SFT-m__qwen25vl-7b__detect"
...
wandb_run_id="Qwen25VL7B-D1m" # run ID must be unique in the wandb_project
